...
<table style="width:100%; border:0; padding:5px;">
	<tr>
		...
		<td style="width:50%; text-align:right;" valign="top"><img
			...
			onclick="window.open( '/monitora/atividade/gantt.php?atiid=<?= $atividade ? $atividade : $projeto ?>', '_blank', 'width=640,height=500,scrollbars=yes,scrolling=yes,resizebled=yes');"
...
<?php } else {?>
<img align="absmiddle" src="../imagens/alterar_01.gif" style="border: 0;" title="Informações Gerais"/>
<?php } ?>
<?php /*echo $status;*/ ?>
...
if( $atividade['qtdrestricoes'] > 0 ): ?> <a href="?modulo=principal/planotrabalhoUN/controle&acao=A&atiid=<?= $atividade['atiid'] ?>"><img src="../imagens/restricao.png" border="0" align="absmiddle" title="<?= $atividade['qtdrestricoes'] ?> <?= $atividade['qtdrestricoes'] == 1 ? 'restrição' : 'restrições' ?>"/></a><?php endif; ?><?php
