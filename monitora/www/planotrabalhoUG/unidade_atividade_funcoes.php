...
function criaTarefaProjeto( $intAnoExercicioAtual, $ungcod){
	...
	$strSql = sprintf("
			Insert Into pde.atividade (atiidpai, atistatus, atidescricao, ungcod, atiordem) values (%s, %s, %s, %s, %d) returning atiid;
			",
			$arrProjeto[ 'atiidpai' ],
	...
	$strSql = sprintf(" update pde.atividade set _atiprojeto = %d where atiid = %d ", $arrProjeto[ 'atiid' ], $arrProjeto[ 'atiid' ] );
