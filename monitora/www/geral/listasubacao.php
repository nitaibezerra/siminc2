...
?>
  <?
   ...
   <tr onmouseover="this.bgColor='#ffffcc';" onmouseout="this.bgColor='';">
    <td><img border="0" src="../imagens/alterar.gif" title="Alterar a atividade." onclick="altera_pto('<?=md5_encrypt($ptoid,'')?>')">&nbsp;&nbsp;&nbsp;
            <? if ($coordaca or $digit) {?>
        
        <img border="0" src="../imagens/excluir.gif" title="Excluir a atividade." onclick="excluir_pto('<?=md5_encrypt($ptoid,'')?>','<?=$ptocod?>')">
