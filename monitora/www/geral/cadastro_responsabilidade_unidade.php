...
if(is_array($_POST['usuuniresp']) && @count($_POST['usuuniresp'])>0) {
	...
	$sqlUpdRpu = "UPDATE monitora.usuarioresponsabilidade SET rpustatus = 'I' WHERE unicod = '%s' AND prsano='".$_SESSION['exercicio']."' AND pflcod = ".$pflcod;

	$sqlUpdRpuUsu = "UPDATE monitora.usuarioresponsabilidade SET rpustatus = 'I' WHERE unicod IS NOT NULL AND unicod != '' AND prsano='".$_SESSION['exercicio']."' AND usucpf = '".$usucpf."' AND pflcod = ".$pflcod;
