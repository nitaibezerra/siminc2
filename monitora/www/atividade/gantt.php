...
// força o projeto a ser trabalhado
define( "PROJETO", $_SESSION['projeto'] );
...
<html>
	...
	<body>
		...
		<img
			src="http://<?= $_SERVER['SERVER_NAME'] ?>/<?= $_SESSION['sisdiretorio'] ?>/atividade/ganttimagem.php?atiid=<?= $atiid ?>"
		/>
	</body>
</html>