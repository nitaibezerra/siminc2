        ...
        <tbody>
         ...
         <tr>
             <td colspan="5" style="padding-top: 15px;">
                 A fidedignidade das informações registradas neste Diário são de responsabilidade do Educadores(as) de:
             </td>
         </tr>
         <tr>
             <td colspan="5" style="padding-top: 15px;" >
                 <table id="tableEducadores" cellspacing="0" cellpadding="0" border="0">
                     <thead>
                         
                        <tr>
                            <td>&nbsp;</td>
                            <td style="width: 200px; text-align: center">NOME</td>
                            <td style="width: 200px; border-right: 1px solid black; text-align: center">ASSINATURA</td>
                        </tr>
                     </thead>
                     <tbody>
                        <tr>
                            <td>Participação Cidadã</td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td>Professor Orientador da Turma</td>
                            <td>&nbsp;</td>
                            <td style="border-right: 1px solid black;">&nbsp;</td>
                        </tr>
    ...
    if( typeof($) == 'function' ){
        $(document).ready(function(){
            ...
            $('#btnImprimirDiario').click(function(){
                ...
                window.open( 'projovemurbano.php?modulo=principal/diarioImpresso&acao=A&tipo=T&difid='+ difId, 'teste' );
            });
