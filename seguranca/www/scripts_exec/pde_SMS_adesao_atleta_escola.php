...
$conteudo = "Gestor Escolar, sua escola pode aderir a 2ª Edição do Atleta na Escola via pdeinterativo.mec.gov.br e receber recursos para realizar a etapa escolar";
...
function getDados()
{
    ...
    $sql = "select celular
			...
			'
			SELECT distinct usucelddd  || usucelnum as celular
