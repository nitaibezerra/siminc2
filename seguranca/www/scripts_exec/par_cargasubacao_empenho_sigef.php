...
class TestCurl implements iSenderConsumer {
	...
	public function __construct(Sender $sender) {
 	...
 	public function readUrls() {
  		global $db;
   		/*  $c = file_get_contents('C:\eclipse\workspace\SIMEC\includes\classes\curl_parallel\urllist.url');
		...
		foreach ($arrEmpenho as $v) {	
			$urls = $_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/seguranca/scripts_exec/carga_ws_empenho_simec_sigef.php?sistema=PAR&ano='.$v['ano'].'&qtdregistro='.$v['total'];
