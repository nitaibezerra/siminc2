...
include_once APPRAIZ . "includes/classes/modelo/par/EmailObras.class.inc";

try{
    echo "# Envio de e-mail iniciado as ".date('d/m/Y G:i:s')."<br />";
    $email = new EmailObras();
    echo "# <strong>Envio de e-mail Finalizado as </strong>".date('d/m/Y G:i:s')."<br />";
} catch (Exception $ex) {
