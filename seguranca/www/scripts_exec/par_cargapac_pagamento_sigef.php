	...
	public function __construct(Sender $sender) {
 	...
 	public function readUrls() {
		...
		foreach ($arrEmpenho as $v) {	
			$urls = $_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'].'/seguranca/scripts_exec/carga_ws_pagamento_simec_sigef.php?sistema=PAC&ano='.$v['ano'].'&qtdregistro='.$v['total'];
...
$strAssunto  = SIGLA_SISTEMA. " - Carga de Processo de Empenho OBRA PAC SIGEF";
