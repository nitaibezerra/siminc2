...
$sql = "select m.iusd, m.fpbid, h.usucpf, pp.pflcod, pp.pfldsc, t.tpeid, i.iuscpf, i.iusnome, f.fpbmesreferencia, f.fpbanoreferencia, pl.plpvalor, un.uniid from sisindigena.mensario m 
...
inner join sisindigena.pagamentoperfil pl on pl.pflcod = t.pflcod 
...
left join sisindigena.pagamentobolsista p on p.iusd = m.iusd and m.fpbid = p.fpbid
where d.esdid=919 and p.pboid is null";
