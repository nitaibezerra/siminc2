                ...
                if($resp[0]) {
                    ...
                    foreach($resp as $r) {
                        ...
                        if(strlen($r['telefone']) >= 10) {
                            ...
                            //}
                            $conteudo = 'Existem '.count($at).' indicadores da secretaria '.$r['secdsc'].' sob sua responsabilidade desatualizados, acesse simec.mec.gov.br e proceda a atualização. MEC';
