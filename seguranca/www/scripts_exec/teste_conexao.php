...
$sql = "select * from seguranca.sistema where sisid = 4";

ver('SIMINC 2', $db->carregar($sql), $db);
ver('SIMINC 1', adapterConnection::oldSiminc()->carregar($sql), adapterConnection::oldSiminc());
