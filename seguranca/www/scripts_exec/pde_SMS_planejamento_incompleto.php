...
$conteudo = "Gestor Escolar, conclua o preenchimento das atividades do Mais Educação e envie para a sua Secretaria para receber apoio financeiro do MEC";
...
function getDados()
{
    ...
    $sql = "select celular
            ...
            WHERE pesstatus = ''A''  and pde.pdistatus = ''A'' and ma.memanoreferencia = ''2014'' and  est.esdid =32
            ')
                                               AS pd (
                                               celular text
                                               )
