...
<script type="text/javascript">
swfobject.embedSWF("/includes/open_flash_chart/open-flash-chart.swf", "grafico<? echo $tpm['codigo']; ?>", "910", "220", "9.0.0", "expressInstall.swf", {"data-file":"chart-data.php?dados=<? echo $_REQUEST['sisid'].";".$_REQUEST['mes'].";".$_REQUEST['ano'].";".$tpm['codigo'].";".$_REQUEST['link']; ?>","loading":"Carregando gráfico..."} );
</script>
</td>
</tr>
<?
