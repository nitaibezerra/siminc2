 ...
 * Adaptação para listar + as ações da unidade orçamentária 
 */
...
$cabecalho = array ("", "PTRES", "Ação", "Unidade Orçamentária", "Dotação inicial", "Dotação SubAção", "Detalhado no PI", "Dotação Disponível" );
