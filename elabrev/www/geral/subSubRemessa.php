	...
	<table width="100%" align="right" cellpadding="0" cellspacing="0" style="color:#003f7e;">
		<?php foreach ( $itens as $item ) : ?>
			<tr onmouseover="this.bgColor='#ffffcc';" onmouseout="this.bgColor='';">
				...
				<td valign="top" style="border-top: 1px solid #cccccc; width: 50px;">
					<?= $item['acacod'] ?>
				</td>
			...
			<tr>
				<td id="td<?= $id ?>" colspan="5" style="padding-left:65px;" align="center"></td>
			</tr>
		<?php endforeach; ?>
	</table>
<?php endif; ?>
