...
if(is_array($_POST['usuunidresp']) && @count($_POST['usuunidresp'])>0) {
	...
	$sqlUpdRpu = "UPDATE elabrev.usuarioresponsabilidade SET rpustatus = 'I' WHERE uncod = '%s' AND pflcod = ".$pflcod;
...
<?
	  ...
	  $sql = "select uniid, unicod, unidsc from unidade where unistatus='A' and orgcod='".$_SESSION['ittorgao']."' order by unicod, unidsc";
