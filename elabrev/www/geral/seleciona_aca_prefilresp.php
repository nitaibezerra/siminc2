<?
 /*
   ...
   Módulo:seleciona_aca_prefilresp.php
...
<thead><tr>
<td valign="top" class="title" style="border-right: 1px solid #c0c0c0; border-bottom: 1px solid #c0c0c0; border-left: 1px solid #ffffff;" colspan="3"><strong>Clique no Programa para selecionar as Unidades</strong></td>
</tr>
<tr>
<?
...
<option value="">Clique no Programa para selecionar as Unidades.</option>
<?	}
}?>
</select>
</form>
...
function retorna(objeto)
{
	...
	if (document.formulario.prgid[objeto].checked == true){
		...
		for(var i=0; i<=campoSelect.length-1; i++){
			...
			if (!campoSelect.options[0]){campoSelect.options[0] = new Option('Clique no Programa para selecionar as Unidades.', '', false, false);}
			sortSelect(campoSelect);
	}
}
