...
ALTER TABLE acompanhamento.acompanhamento ADD COLUMN acojustificativa text;
COMMENT ON COLUMN acompanhamento.acompanhamento.acojustificativa IS 'Justificativa do Indicador';

ALTER TABLE acompanhamento.acompanhamento
   ALTER COLUMN suoid DROP NOT NULL;
