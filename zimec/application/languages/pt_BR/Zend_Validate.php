...
return array(
    ...
    "A record matching '%value%' was found" => "Já existe um registro com a descrição '%value%'",
    ...
    "You must give a non-empty value for field '%field%'" => "O valor é obrigatório e não pode estar vazio",
