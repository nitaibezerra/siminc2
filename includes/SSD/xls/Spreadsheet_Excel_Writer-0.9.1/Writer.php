...
require_once DIR_COMPONENT . "pear/PEAR.php";
require_once DIR_COMPONENT . "pear/xls/Spreadsheet_Excel_Writer-0.9.1/Writer/Workbook.php";
...
class Spreadsheet_Excel_Writer extends Spreadsheet_Excel_Writer_Workbook
{
    ...
    */
    function Spreadsheet_Excel_Writer($filename = '')
    {
        ...
        $this->Spreadsheet_Excel_Writer_Workbook( "" );
    }
