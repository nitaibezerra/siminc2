 ...
 * @see Zend_Loader
 */
require_once APPRAIZ_ZEND . 'Loader.php';

/**
 * @see Zend_Filter
 */
require_once APPRAIZ_ZEND . 'Filter.php';

/**
 * @see Zend_Validate
 */
require_once APPRAIZ_ZEND . 'Validate.php';
...
class Zend_Filter_Input
{
    ...
    public function setPluginLoader(Zend_Loader_PluginLoader_Interface $loader, $type)
    {
        ...
        switch ($type) {
            ...
            case self::VALIDATE:
                ...
                return $this;
            default:
                require_once APPRAIZ_ZEND . 'Filter/Exception.php';
    ...
    public function setTranslator($translator = null)
    {
        if ((null === $translator) || ($translator instanceof Zend_Translate_Adapter)) {
            ...
            require_once APPRAIZ_ZEND . 'Validate/Exception.php';
    ...
    public function getTranslator()
    {
        ...
        if ($this->_translator === null) {
            require_once APPRAIZ_ZEND . 'Registry.php';
