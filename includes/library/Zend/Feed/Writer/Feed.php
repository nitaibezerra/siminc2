 ...
 * @see Zend_Date
 */
require_once APPRAIZ_ZEND . 'Uri.php';

/**
 * @see Zend_Feed_Writer
 */
require_once APPRAIZ_ZEND . 'Feed/Writer.php';

/**
 * @see Zend_Feed_Writer_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Writer/Entry.php';

/**
 * @see Zend_Feed_Writer_Deleted
 */
require_once APPRAIZ_ZEND . 'Feed/Writer/Deleted.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Atom
 */
require_once APPRAIZ_ZEND . 'Feed/Writer/Renderer/Feed/Atom.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Rss
 */
require_once APPRAIZ_ZEND . 'Feed/Writer/Renderer/Feed/Rss.php';

require_once APPRAIZ_ZEND . 'Feed/Writer/Feed/FeedAbstract.php';
