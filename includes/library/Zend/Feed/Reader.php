 ...
 * @see Zend_Feed
 */
require_once APPRAIZ_ZEND . 'Feed.php';

/**
 * @see Zend_Feed_Reader_Feed_Rss
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Feed/Rss.php';

/**
 * @see Zend_Feed_Reader_Feed_Atom
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Feed/Atom.php';

/**
 * @see Zend_Feed_Reader_FeedSet
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/FeedSet.php';
...
class Zend_Feed_Reader
{
    ...
    public static function getHttpClient()
    {
        if (!self::$_httpClient instanceof Zend_Http_Client) {
             ...
             */
            require_once APPRAIZ_ZEND . 'Http/Client.php';
    ...
    public static function getPluginLoader()
    {
        if (!isset(self::$_pluginLoader)) {
            require_once APPRAIZ_ZEND . 'Loader/PluginLoader.php';
