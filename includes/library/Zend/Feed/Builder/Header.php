 ...
 */
require_once APPRAIZ_ZEND . 'Feed/Builder/Header/Itunes.php';
...
class Zend_Feed_Builder_Header extends ArrayObject
{
    ...
    public function setEmail($email)
    {
        ...
        if (!$validate->isValid($email)) {
             ...
             */
            require_once APPRAIZ_ZEND . 'Feed/Builder/Exception.php';
    ...
    public function setTtl($ttl)
    {
         ...
         */
        require_once APPRAIZ_ZEND . 'Validate/Int.php';
