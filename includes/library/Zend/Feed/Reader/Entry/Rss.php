 ...
 */
require_once APPRAIZ_ZEND . 'Feed/Reader.php';

/**
 * @see Zend_Feed_Reader_EntryInterface
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/EntryInterface.php';

/**
 * @see Zend_Feed_Reader_EntryAbstract
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/EntryAbstract.php';

/**
 * @see Zend_Feed_Reader_Extension_DublinCore_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Extension/DublinCore/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Content_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Extension/Content/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Atom_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Extension/Atom/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_WellformedWeb_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Extension/WellFormedWeb/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Slash_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Extension/Slash/Entry.php';

/**
 * @see Zend_Feed_Reader_Extension_Thread_Entry
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Extension/Thread/Entry.php';

/**
 * @see Zend_Date
 */
require_once APPRAIZ_ZEND . 'Date.php';

/**
 * @see Zend_Feed_Reader_Collection_Category
 */
require_once APPRAIZ_ZEND . 'Feed/Reader/Collection/Category.php';
                    ...
                    foreach ($dateStandards as $standard) {
                        try {
                            ...
                            if ($standard == Zend_Date::DATES) {
                                require_once APPRAIZ_ZEND . 'Feed/Exception.php';
