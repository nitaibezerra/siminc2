 ...
 */
require_once APPRAIZ_ZEND . 'Http/UserAgent/Storage.php';

/**
 * @see Zend_Session_Namespace
 */
require_once APPRAIZ_ZEND . 'Session/Namespace.php';
...
class Zend_Http_UserAgent_Storage_Session implements Zend_Http_UserAgent_Storage
{
    ...
    public function __construct($options = null)
    {
        ...
        if (null !== $options && !is_array($options)) {
            require_once APPRAIZ_ZEND . 'Http/UserAgent/Storage/Exception.php';
