 ...
 */
require_once APPRAIZ_ZEND . 'Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once APPRAIZ_ZEND . 'Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once APPRAIZ_ZEND . 'Http/Response/Stream.php';
...
class Zend_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Zend_Uri_Http) {
            ...
            require_once APPRAIZ_ZEND . 'Http/Client/Exception.php';
