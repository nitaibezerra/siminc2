...
class Zend_Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if ((null !== $dirs) && !is_string($dirs) && !is_array($dirs)) {
            require_once APPRAIZ_ZEND . 'Exception.php';
    ...
    {
        trigger_error(__CLASS__ . '::' . __METHOD__ . ' is deprecated as of 1.8.0 and will be removed with 2.0.0; use Zend_Loader_Autoloader instead', E_USER_NOTICE);
        require_once APPRAIZ_ZEND . 'Loader/Autoloader.php';
    ...
    public static function standardiseFile($file)
    {
        ...
        // Função criada para alterar a raiz (localizada em includes/library/simec/funcoes.inc)
