...
/*
	...
	Finalidade: Submissão de dados oriundos da Câmara
*/

if ( $_REQUEST['form']  )
{
	// define dados para a importação
	$nome = date( 'Ymd' ) . 'csv';
	...
	if ( $_FILES["arquivo_csv"]["tmp_name"] != '' )
	{
		...
		// abre popup que realiza importação
		?>
...
?>
<br/>
<? monta_titulo( 'Importar Dados Câmara', '' ); ?>
	...
	<table class="tabela" cellSpacing="1"  cellPadding="3" bgcolor="#f5f5f5" align="center" >
		...
		<tr>
			...
			<td width="80%">
				...
				<label for="ex">Execução Orçamentária</label>
			</td>
		</tr>
		<tr>
			<!-- tipo -->
			<td width="20%" align="right" class="SubTituloDireita" >Atualizar de Programas e Ações</td>
			<td width="80%">
				<!-- Atualização de nomes de Programas e Ações -->
