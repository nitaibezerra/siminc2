...
<?php
	$sql = sprintf(
		"select distinct * from financeiro.tiporesponsabilidade tr inner join  financeiro.tprperfil tp on tr.tprcod = tp.tprcod where tp.pflcod = %d and tr.tprsnvisivelperfil = 't'",
		$pflcod
	);	
