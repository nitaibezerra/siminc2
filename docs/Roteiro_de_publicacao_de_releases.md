...
Hotfix á uma alteração emergencial a ser aplicada à produção. Envolve alguns commits no máximo e dificilmente dura mais que um dia.
...
Para criar uma hotfix, siga os passos abaixo:
    ...
    * preencha a release com:
      ...
      - texto descritivo contendo modelo anterior do CHANGELOG (listagem de novas funcionalidades):
        Release 2.x.x
	* [FIX] Àrea do sistema: descrição da alteração (#3 [número da issue])
