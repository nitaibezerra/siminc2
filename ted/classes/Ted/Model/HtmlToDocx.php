...
require_once APPRAIZ . 'ted/classes/htmlToDocx/phpword/PHPWord.php';
require_once APPRAIZ . 'ted/classes/htmlToDocx/simplehtmldom/simple_html_dom.php';
require_once APPRAIZ . 'ted/classes/htmlToDocx/htmltodocx_converter/h2d_htmlconverter.php';
require_once APPRAIZ . 'ted/classes/htmlToDocx/example_files/styles.inc';

/**
 * Exemplo de uso
 *
 * include_once APPRAIZ . 'path/to/repository/class/Ted/Model/HtmlToDocx.php';
