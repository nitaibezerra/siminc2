<h4><label for="indid">Indicador</label></h4>

<div class="col-lg-12">
    <select class="form-control" name="indid[]" id="indid" multiple="multiple">
        <?= $this->indicadorSolucao->getOptionsIndicador($this->where, $this->dados); ?>
    </select>
</div>
