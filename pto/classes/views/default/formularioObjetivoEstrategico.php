<h4>
    <label for="obeid"><?= $this->aeObjetivoEstrategico->getAttributeLabel('obenome'); ?></label>
    <span class="alert-danger" style="background-color: #FFF; font-size: 19px; ">*</span>
</h4>

<div class="col-lg-12">
    <select class="form-control" name="obeid[]" id="obeid" multiple="multiple">
        <?= $this->aeObjetivoEstrategico->getOptionsObjetivoEstrategico($this->where, $this->dados); ?>
    </select>
</div>
