<h4>
	<label for="iniid"><?= $this->aeIniciativa->getAttributeLabel('ininome'); ?></label>
</h4>

<div class="col-lg-12 ">
	<select class="form-control" name="iniid[]" id="iniid" multiple="multiple">
		<?= $this->aeIniciativa->getOptionsIniciativa($this->where, $this->dados); ?>
	</select>
</div>
