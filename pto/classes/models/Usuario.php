...
class Model_Usuario extends Abstract_Model
{
	...
	public function __construct($commit = true)
	{
		...
		$this->entity['entid'] = array('value' => '', 'type' => 'integer', 'is_null' => 'NO', 'maximum' => '', 'contraint' => 'fk', 'label' => 'Órgão');
	...
	{
		$assunto = 'Inscrição no Cadastro do SIMEC - Planos Táticos Operacionais';
		...
		$mensagem .= "<br><br>Você foi cadastrado(a) no SIMEC como Executor, no sistema de Planos Táticos Operacionais - PTO.";
	...
	public function getListing( $parans = array() )
	{
		...
		$list->setQuery($sql)
			->setCabecalho(array('CPF ', 'Nome', 'Telefone', 'E-mail', 'UF', 'Município'))
