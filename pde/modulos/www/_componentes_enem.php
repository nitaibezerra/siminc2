...
<?php if( $permissao ): ?>
	<?php if( $atividade['profundidade'] == 1 ): ?>
		<img
			align="absmiddle"
			src="/imagens/alterar.gif"
			style="cursor: pointer"
			onclick="window.location.href = '?modulo=principal/atividade_enem/projeto&acao=A&atiid=<?= $atividade['atiid'] ?>'"
...
<!-- VERIFICA CHECKLIST -->
<?php if( $atividade['atitipoenem'] == 'A' ): ?>
	<a href="?modulo=principal/atividade_enem/listar_checklist&acao=A&atiid=<?= $atividade['atiid'] ?>">
		<? 
