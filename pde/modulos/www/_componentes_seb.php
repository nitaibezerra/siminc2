...
<script>
		...
		var URL_AJAX = 'http://<?= $_SERVER['SERVER_NAME'] ?>/<?= $diretorio ?>/ajax_seb.php'
			+ '?atividade=<?= $atividade ?>'
...
<td style="font-weight:bold; text-align:center;">Título</td><td style="font-weight:bold; text-align:center;">Usuário</td>
...
<a href="?modulo=principal/atividade_seb/atividade&acao=A&atiid=<?= $atividade['atiid'] ?>"><img align="absmiddle" src="../imagens/alterar.gif" style="border: 0;" title="Informações Gerais"/></a>
...
if($existesubacao  ) {
?>
<a style="cursor:pointer;" onclick="janela = window.open('/pde/pde.php?modulo=principal/atividade_seb/vincularsubacoesatividadePDE&acao=A&atiid=<?= $atividade['atiid'] ?>', 'janela1', 'menubar=no,location=no,resizable=no,scrollbars=yes,status=yes,width=800,height=400' ); janela.focus();"><img src="../imagens/valida4.gif" border="0" align="top" title="Inserir subação"/></a>	
<?
} else {
?>
<a style="cursor:pointer;" onclick="janela = window.open('/pde/pde.php?modulo=principal/atividade_seb/vincularsubacoesatividadePDE&acao=A&atiid=<?= $atividade['atiid'] ?>', 'janela1', 'menubar=no,location=no,resizable=no,scrollbars=yes,status=yes,width=800,height=400' ); janela.focus();"><img src="../imagens/valida2.gif" border="0" align="top" title="Inserir subação"/></a>
<?
}
	}
?>
...
if( $atividade['qtdrestricoes'] > 0 ): ?> <a href="?modulo=principal/atividade_seb/controle&acao=A&atiid=<?= $atividade['atiid'] ?>"><img src="../imagens/restricao.png" border="0" align="absmiddle" title="<?= $atividade['qtdrestricoes'] ?> <?= $atividade['qtdrestricoes'] == 1 ? 'restrição' : 'restrições' ?>"/></a><?php endif; ?><?php
if( $atividade['qtdanexos'] > 0 ): ?> <a href="?modulo=principal/atividade_seb/instrumento&acao=A&atiid=<?= $atividade['atiid'] ?>"><img src="../imagens/clipe.gif" border="0" align="absmiddle" title="<?= $atividade['qtdanexos'] ?> <?= $atividade['qtdanexos'] == 1 ? 'anexo' : 'anexos' ?>"/></a><?php endif;
...
<span style="margin: 0 5px 0 0; <?= $permissao ? '' : 'color:#909090;' ?>"><?php
	...
	?> <?= $numero ?></span><a id="link<?= $atividade['atiid'] ?>" href="?modulo=principal/atividade_seb/subatividades&acao=A&atiid=<?= $atividade['atiid'] ?>" onmouseover="window.SuperTitleOn( this , '<b>' + this.innerHTML + '</b><?= $descricao ?>' )" onmouseout="window.SuperTitleOff( this )" style="<?= $permissao ? '' : 'color:#909090;' ?>"><?= $atividade['atidescricao'] ?></a>
</div>
...
function montar_formulario_pesquisa( $foco = false ){
	...
	$formulario = sprintf(
	'<form action="/%s/%s.php?modulo=principal/atividade_seb/pesquisa&acao=A" method="post" name="pesquisa">
