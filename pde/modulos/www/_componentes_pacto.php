...
<script>
		...
		var URL_AJAX = 'http://<?= $_SERVER['SERVER_NAME'] ?>/<?= $diretorio ?>/ajax_pacto.php'
			+ '?atividade=<?= $atividade ?>'
...
<a href="?modulo=principal/atividade_pacto/atividade&acao=P&atiid=<?= $atividade['atiid'] ?>">
<img align="absmiddle" src="../imagens/alterar.gif" style="border: 0;" title="Informações Gerais"/>
</a>
<?php endif;?>
<?php if( $atividade['atitipoenem'] == 'S' ): ?>
<a href="?modulo=principal/atividade_pacto/atividade&acao=S&atiid=<?= $atividade['atiid'] ?>">
<img align="absmiddle" src="../imagens/alterar.gif" style="border: 0;" title="Informações Gerais"/>
</a>
<?php endif;?>
<?php if( $atividade['atitipoenem'] == 'A' ): ?>
<a href="?modulo=principal/atividade_pacto/dados_atividade&acao=A&atiid=<?= $atividade['atiid'] ?>">
<img align="absmiddle" src="../imagens/alterar.gif" style="border: 0;" title="Informações Gerais"/>
</a>
<?php endif;?>
...
<!-- VERIFICA CHECKLIST -->
<?php if( $atividade['atitipoenem'] == 'A' ): ?>
	<a href="?modulo=principal/atividade_pacto/listar_checklist&acao=A&atiid=<?= $atividade['atiid'] ?>">
		<? 
		...
		$sql = "select count(icl.iclid) as total from pde.itemchecklist icl
					...
					AND esdid <> ".PACTO_EST_EM_FINALIZADO;	
...
if( $atividade['qtdrestricoes'] > 0 ): ?> <a href="?modulo=principal/atividade_pacto/controle&acao=A&atiid=<?= $atividade['atiid'] ?>"><img src="../imagens/restricao.png" border="0" align="absmiddle" title="<?= $atividade['qtdrestricoes'] ?> <?= $atividade['qtdrestricoes'] == 1 ? 'restrição' : 'restrições' ?>"/></a><?php endif; ?><?php
if( $atividade['qtdanexos'] > 0 ): ?> <a href="?modulo=principal/atividade_pacto/instrumento&acao=A&atiid=<?= $atividade['atiid'] ?>"><img src="../imagens/clipe.gif" border="0" align="absmiddle" title="<?= $atividade['qtdanexos'] ?> <?= $atividade['qtdanexos'] == 1 ? 'anexo' : 'anexos' ?>"/></a><?php endif;
...
<span style="margin: 0 5px 0 0; <?= $permissao ? '' : 'color:#909090;' ?>"><?php
	...
	<?php if( $atividade['atitipoenem'] == 'E' ): ?>
	<a id="link<?= $atividade['atiid'] ?>" href="?modulo=principal/atividade_pacto/subatividades&acao=E&atiid=<?= $atividade['atiid'] ?>" onmouseover="window.SuperTitleOn( this , '<b>' + this.innerHTML + '</b><?= $descricao ?>' )" onmouseout="window.SuperTitleOff( this )" style="color:#000099">(E)
	<?= $atividade['atidescricao'] ?>
	</a>
	<?php elseif( $atividade['atitipoenem'] == 'P' ): ?>
	<a id="link<?= $atividade['atiid'] ?>" href="?modulo=principal/atividade_pacto/subatividades&acao=P&atiid=<?= $atividade['atiid'] ?>" onmouseover="window.SuperTitleOn( this , '<b>' + this.innerHTML + '</b><?= $descricao ?>' )" onmouseout="window.SuperTitleOff( this )" style="color:#0033FF">(P)
	<?= $atividade['atidescricao'] ?>
	</a>
	<?php elseif( $atividade['atitipoenem'] == 'S' ): ?>
	<a id="link<?= $atividade['atiid'] ?>" href="?modulo=principal/atividade_pacto/subatividades&acao=S&atiid=<?= $atividade['atiid'] ?>" onmouseover="window.SuperTitleOn( this , '<b>' + this.innerHTML + '</b><?= $descricao ?>' )" onmouseout="window.SuperTitleOff( this )" style="color:#006600">(S)
	<?= $atividade['atidescricao'] ?>
	</a>
	<?php elseif( $atividade['atitipoenem'] == 'A' ): ?>
	<a id="link<?= $atividade['atiid'] ?>" href="?modulo=principal/atividade_pacto/subatividades&acao=A&atiid=<?= $atividade['atiid'] ?>" onmouseover="window.SuperTitleOn( this , '<b>' + this.innerHTML + '</b><?= $descricao ?>' )" onmouseout="window.SuperTitleOff( this )" style="color:#009933">(A)
	<?= $atividade['atidescricao'] ?>
	</a>
	<?php endif; ?>
...
function montar_formulario_pesquisa( $foco = false ){
	...
	$formulario = sprintf(
	'<form action="/%s/%s.php?modulo=principal/atividade_pacto/pesquisa&acao=A" method="post" name="pesquisa">
