...
include '_funcoes_ci.php';
include '_componentes_ci.php';
	...
	if($usucpf){
		...
		if($email){
			...
			$conteudo = "
				...
				<br><br>
				<br>	
				<a href=\"http://simec.mec.gov.br/pde/pde.php?modulo=principal/atividade_ci/atividade&acao=A&atiid={$_REQUEST['idAtividade']}\">Clique Aqui para acessar a atividade.</a>
				<br>	
				<br>		
				Atenciosamente,
				<br>	
