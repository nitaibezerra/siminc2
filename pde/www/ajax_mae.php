...
include '_funcoes_mae.php';
include '_componentes_mae.php';
	...
	if($usucpf){
		...
		if($email){
			...
			$conteudo = "
				...
				<br><br>
				<br>	
				<a href=\"http://simec.mec.gov.br/pde/mae.php?modulo=principal/atividade_mae/atividade&acao=A&atiid={$_REQUEST['idAtividade']}\">Clique Aqui para acessar a atividade.</a>
				<br>	
				<br>		
				Atenciosamente,
				<br>	
