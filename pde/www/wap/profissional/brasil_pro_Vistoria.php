	...
	<div data-theme="a" data-role="page">
		<div data-role="header" data-position="fixed" data-theme="a">
			...
			<div data-role="navbar">
				<ul>
					<li><a class="ui-btn-active" data-theme="a" href="brasil_pro.php" data-transition="slide" >Brasil Profissionalizado </a></li>
				</ul>
			</div>
			</div>
			<div data-role="content">
				<ul data-role="listview" data-inset="true">
					<li><a data-transition="flip" href="brasil_pro_Vistoria.php">Vistorias</a></li>
					<tr>
						<td>
							<div>
								<img style="float:left" src="../../../imagens/icones/icons/cone.png" style="vertical-align:middle;"  />
							</div>
							<?=montaTabelaVistoriaObras(3, 'N', 'N')?>
						</td>
					</tr>
					<li>
