	...
	<div data-role="header" data-position="fixed">
		...
		<div data-role="navbar">
			...
			<ul>	
				...
				<li><a data-theme="a" href="basico_pacto.php"  data-transition="slide">Pacto pela Alfabetização</a></li>
				<li><a data-theme="a" href="basico_maiseducacao.php"  data-transition="slide">Mais Educação</a></li>
			</ul>
		</div>
	</div>
