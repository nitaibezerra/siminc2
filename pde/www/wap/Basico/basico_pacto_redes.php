	...
	<div data-role="content">
	 ...
	 <ul data-role="listview" data-inset="true">
			...
			<div>
				...
				<div style="float:left;" class="titulo_box" ><BR><b>Redes que já realizaram a formação inicial dos orientadores de estudo</b></div>
			</div>
			<?php
			...
			<table class="tabela_box" cellpadding="2" cellspacing="1" width="100%" >
				...
				<tr  height="30">
                	<td class="" style="background-color:#3B8550"><?php echo $dado['tipo'] ?></td>
                	<td class="numero" style="background-color:#3B8550"><?php echo number_format($dado['total'],0,",",".") ?></td>
				</tr>
				<?php endforeach; ?>
			</table>
		</td>
