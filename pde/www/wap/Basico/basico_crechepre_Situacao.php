	...
	<div data-theme="a" data-role="page">
		<div data-role="header" data-position="fixed">
			...
			<div data-role="navbar">
				<ul>
					<li><a class="ui-btn-active" data-theme="a" href="basico_crechepre.php" data-transition="slide" >Creches e Pré-Escolas </a></li>
				</ul>
			</div>
		</div>
		<div data-role="content">
			<ul data-role="listview" data-inset="true">
				...
				<li><a data-transition="flip" href="basico_crechepre_Situacao.php">Situação das Obras</a></li>
				<tr>
					<td class="fundo_td" rowspan="2" >
						<div>
							<img style="float:left" src="../../../imagens/icones/icons/obras.png" style="vertical-align:middle;"  />
							<div style="float:left" class="titulo_box" ><br>Situação das Obras<br/></div>
						</div>
