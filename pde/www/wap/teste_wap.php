...
<div " data-role="page">
	<div  data-role="header" data-position="fixed">
		...
		<div data-role="navbar">
			<ul>
				<li><a data-theme="e" class="ui-btn-active" href="#" onclick="javascript:filtraEstado('todos')" >Todas (<span id="span_total">0</span>)</a></li>
				<li><a data-theme="e" href="#" onclick="javascript:filtraEstado('estavel')">Estável (<span id="span_estavel">0</span>)</a></li>
				<li><a data-theme="e" href="#" onclick="javascript:filtraEstado('atencao')">Atenção (<span id="span_atencao">0</span>)</a></li>
				<li><a data-theme="e" href="#" onclick="javascript:filtraEstado('critico')">Crítico (<span id="span_critico">0</span>)</a></li>
				<li><a data-theme="e" href="#" onclick="javascript:filtraEstado('nao_executado')">Não Executado (<span id="span_nao_executado">0</span>)</a></li>
			</ul>
		</div>
	</div>
