...
<script>
		...
		function aposAtualizarBarraStatus( intBarraStatusId , strStatus , intStatus, intPercentual )
		{
			...
			if(confirm("A porcentagem foi atualizada com sucesso. \n\nClique em 'OK' para atualizar a árvore e seus status ou \n\n clique em 'Cancelar' para atualizar mais tarde.")){
				//location.href = 'projetos.php?modulo=principal/atividade_/arvore&acao=A';
