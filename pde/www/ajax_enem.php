	...
	if($usucpf){
		...
		if($email){
			...
			$conteudo = "
				...
				<br><br>
				<br>	
				<a href=\"http://simec.mec.gov.br/pde/enem.php?modulo=principal/atividade_enem/atividade&acao=A&atiid={$_REQUEST['idAtividade']}\">Clique Aqui para acessar a atividade.</a>
				<br>	
				<br>		
				Atenciosamente,
				<br>	
