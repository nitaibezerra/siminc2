...
include '_funcoes_pacto.php';
include '_componentes_pacto.php';
	...
	if($usucpf){
		...
		if($email){
			...
			$conteudo = "
				...
				<br><br>
				<br>	
				<a href=\"http://simec.mec.gov.br/pde/pacto.php?modulo=principal/atividade_pacto/atividade&acao=A&atiid={$_REQUEST['idAtividade']}\">Clique Aqui para acessar a atividade.</a>
				<br>	
				<br>		
				Atenciosamente,
				<br>	
