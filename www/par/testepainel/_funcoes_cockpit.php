...
function montaTabelaExamesMec($nomeindicador, $arrNumeroProjeto, $subtitulo='')
{
	...
	$sql = "SELECT numero || '-' || atidescricao as atidescricao, situacao, count(0) as total
			FROM (
				SELECT DISTINCT
					...
					CASE
						WHEN ch1.entid IS NOT NULL AND ch2.entid IS NOT NULL AND ch3.entid IS NOT NULL THEN
							CASE
							...
							ELSE 'A Executar'
							END
						WHEN ch1.entid IS NOT NULL AND ch2.entid IS NOT NULL AND ch3.entid IS NULL THEN
							CASE
							...
							ELSE 'A Executar'
							END
						WHEN ch1.entid IS NOT NULL AND ch2.entid IS NULL AND ch3.entid IS NULL THEN
							CASE
	...
	<table class="tabela_box" cellpadding="2" cellspacing="1" width="100%" >
		<?php if(in_array(26, $arrNumeroProjeto) || in_array(18, $arrNumeroProjeto) || in_array(19, $arrNumeroProjeto)){ ?>
			<tr>
