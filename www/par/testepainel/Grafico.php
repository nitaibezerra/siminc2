        ...
        <script type="text/javascript">
            jQuery(function () {
                ...
                jQuery('#<?php echo $this->id; ?>').highcharts({
                    ...
                    xAxis: {
                        categories: <?php echo simec_json_encode($this->dados['categories']); ?>,

                        <?php if($this->labelX){ ?>
                        labels: <?php echo simec_json_encode($this->labelX); ?>,
                        <?php } ?>
...
//                                    },
                    ...
                    series: <?php echo simec_json_encode($this->dados['series']); 
