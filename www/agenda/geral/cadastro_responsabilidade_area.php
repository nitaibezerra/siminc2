...
<thead>
	<tr>
		<td valign="top" class="title" style="border-right: 1px solid #c0c0c0; border-bottom: 1px solid #c0c0c0; border-left: 1px solid #ffffff;" colspan="3"><strong>Selecione a(s) Área(s)</strong></td>
	</tr>
   	<tr bgcolor="<?=$cor?>">
...
<?
	  ...
	  $cabecalho = 'Selecione a(s) Área(s)';
	  $sql = "SELECT 
	  			aevid, 
...
?>
	<option value="">Selecione a(s) Área(s).</option>
<?
}
?>
</select>
...
function retorna(objeto)
{
	...
	if (document.formulario.prgid[objeto].checked == true){
		...
		for(var i=0; i<=campoSelect.length-1; i++){
			...
			if (!campoSelect.options[0]){campoSelect.options[0] = new Option('Selecione a(s) Área(s).', '', false, false);}
			sortSelect(campoSelect);
	}
}
