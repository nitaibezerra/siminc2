...
//curl_setopt($this->ch, CURLOPT_CAINFO, 'f:\php-4.3.2-win32\extensions\curl-ca-bundle.crt');		
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=30, $cookies=NULL, $d = 0) {
            	...
            	foreach($children as $child_pos){
            		if($notstruct){
            			...
            			if (isset($params[$this->message[$child_pos]['name']])) {
            				//echo $this->message[$child_pos]['name']."<br />";
					    	...
					    	$params[$this->message[$child_pos]['name']] = &$this->message[$child_pos]['result'];
					    	//echo ($this->message[$child_pos]['name']." = ".$this->message[$child_pos]['result']."<br />"); 
					    }
                	}
                }
			}
		...
		switch(true){
			...
			case ereg('^http',$this->endpoint):
				...
				//if(strpos($this->endpoint,'http:')){				
					$this->responseData = $http->send($msg,$timeout,$response_timeout,$this->cookies, 1);					
