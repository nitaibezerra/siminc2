...
function gerenciarProgramas(sprmodulo, spoid) {
	window.open('pdeinterativo2013.php?modulo=principal/diagnostico&acao=A&requisicao=gerenciarProgramas&sprmodulo='+sprmodulo+'&spoid='+spoid,'Programas','scrollbars=no,height=400,width=600,status=no,toolbar=no,menubar=no,location=no');
}

function gerenciarProjetos(sprmodulo, sprid) {
	window.open('pdeinterativo2013.php?modulo=principal/diagnostico&acao=A&requisicao=gerenciarProjetos&sprmodulo='+sprmodulo+'&sprid='+sprid,'Projetos','scrollbars=no,height=300,width=500,status=no,toolbar=no,menubar=no,location=no');
}
...
function irTelaPrincipal() {
	window.location='pdeinterativo2013.php?modulo=principal/principalDiretor&acao=A';
}
...
{
	var url = 'http://pdeinterativo2013.mec.gov.br/geral/workflow/historico.php' +
