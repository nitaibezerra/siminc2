	...
	if(isset($_POST['usuunidresp'])){
		foreach($_POST['usuunidresp'] as $muncod) {
		   ...
		   ";
			...
			$sqlQtd = "
				select count(*) as qtd from pdeinterativo2013.usuarioresponsabilidade 
				where
				   		usucpf  	= '$usucpf' and
				   		pflcod 	    =  $pflcod and
				   		muncod  	= '$muncod'
...
<table>
	...
	$sql = "
			...
			from 
				pdeinterativo2013.usuarioresponsabilidade ur inner join territorios.municipio m on ur.muncod::integer = m.muncod::integer
