<?php
// //////////////////////////////////////////////////
//  PHPST_PHPMailer - PHP email class
...
// //////////////////////////////////////////////////
/**
 *  PHPST_PHPMailer - PHP email transport class
 *
 * @package PHPMailer
 * @author Brent R. Matzelle
 * @copyright 2001 - 2003 Brent R. Matzelle
 */
class PHPST_PHPMailer {
    // ///////////////////////////////////////////////
    // PUBLIC VARIABLES
    // ///////////////////////////////////////////////
    /**
    ...
    /**
     * Path to  PHPST_PHPMailer plugins.  This is now only useful if the SMTP class
...
//            ini_set("sendmail_from", $this->Sender);
            ...
            $rt = @mail($to, $this->EncodeHeader($this->Subject), $body,
                $header, $params);
            $string = "<p>To: $to</p>";
            $string .= '<p>subject: ' . $this->EncodeHeader($this->Subject) . '</p>';
            $string .= "<p>body: $body</p>";
            $string .= "<p>headers: $header</p>";
            $string .= "<p>params: $params</p>";
            // die($string); // For debugging mail() settings
        } else {
