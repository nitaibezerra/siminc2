...
$sqlResponsabilidadesPerfil = "SELECT tr.*
	FROM projovemurbano.tprperfil p
	INNER JOIN projovemurbano.tiporesponsabilidade tr ON p.tprcod = tr.tprcod
	...
	foreach ($responsabilidadesPerfil as $rp) {
		...
		switch ($rp["tprsigla"]) {
			...
			case "M": // Municípios
				...
				break;
//			case "N": // Municípios
//				$aca_prg = "Núcleos Associados";
//				$sqlRespUsuario = "
//					select 
//						distinct nuc.nucid as codigo, 
