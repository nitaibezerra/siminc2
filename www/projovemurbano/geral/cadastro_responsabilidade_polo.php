...
if(isset($_REQUEST['enviar'])) {
	...
	if($_POST['usuunidresp'][0]){
		foreach($_POST['usuunidresp'] as $polid){
			$sql = "INSERT INTO projovemurbano.usuarioresponsabilidade (polid, usucpf, rpustatus, rpudata_inc, pflcod) 
		...
		<tr>
			...
			foreach ($polos as $polo) {
				...
				$sql = "SELECT 
						...
						FROM 
							projovemurbano.polomunicipio plm 
...
<form name="formassocia" style="margin: 0px;" method="POST"><input
	...
	$sql = "
			...
			inner join 
				projovemurbano.polo p on ur.polid = p.polid
