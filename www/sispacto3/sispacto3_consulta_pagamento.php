...
if($_POST['requisicao']=='consultarPagamento') :
	...
	if(strlen(trim($_POST['datanascimento']))==10 && strlen(trim($_POST['cpf']))==14) {
		$sql = "SELECT uncid, iusd FROM sispacto2.identificacaousuario WHERE iuscpf='".str_replace(array(".","-"),array("",""),$_POST['cpf'])."' AND iusdatanascimento='".formata_data_sql($_POST['datanascimento'])."'";
