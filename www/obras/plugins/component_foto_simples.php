...
function deletarfotos($dados) {
	...
	if($_SESSION['obras2']['supid']) {
		$fotid = $db->pegaUm("SELECT fotid FROM obras2.fotos WHERE obrid='".$_SESSION['obras2']['obrid']."' AND supid='".$_SESSION['obras2']['supid']."' AND fotordem='".($dados['fotordem']-1)."'");
...
//				} else {
//					var imagem = "<img id='"+id+"' style='width:68px;height:68px;' src='./plugins/resize.php?img=../../../arquivos/obras2/imgs_tmp/"+id+"&w=68&h=68'><input type='hidden' id='"+child[k].id+"_"+id+"' name='"+child[k].id+"' value='"+id+"'>";
//					child[k].innerHTML = imagem;
//				}
//				break;
//			}
