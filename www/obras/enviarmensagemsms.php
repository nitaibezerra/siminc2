...
if($dados[0]) {
	...
	foreach($dados as $key => $d) {
		...
		$mensagem->Body .= "<p>Existem <b>".$d['num']."</b> obras desatualizadas sob sua referentes a unidade <b>".$d['entnome']."</b>. Acesse o <a href=http://simec.mec.gov.br/ target=_blank>SIMEC - Monitoramento de obras</a> (http://simec.mec.gov.br/) e realize as atualizações.</p>";
