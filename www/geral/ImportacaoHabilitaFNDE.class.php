...
class importacaoHabilitaFNDE {
	...
	function __construct($diretorio, $arTipo ){
		...
		//enviar_email(array("nome" => SIGLA_SISTEMA. " EMENDAS","email" => $_SESSION['email_sistema']), $_SESSION['email_sistema'], "Start do script", "TESTE", $_SESSION['email_sistema']);
        ...
        ob_clean();
        enviar_email(array("nome" => SIGLA_SISTEMA. " EMENDAS","email" => $_SESSION['email_sistema']), $_SESSION['email_sistema'], "1º Passo do script", $saida, $_SESSION['email_sistema']);*/
