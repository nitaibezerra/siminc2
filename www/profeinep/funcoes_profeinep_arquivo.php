...
function montaListaArquivosProfeinep()
{
	...
	array_push($cabecalho, "Nº do Processo SIDOC", "Interessado","Prioridade","Coordenação", "Situação PROFE/INEP","ID do Arquivo", "Nome do arquivo", "Descrição do Arquivo", "Tamanho (bytes)", "Data da inclusão (arquivo)", "");
