...
include_once APPRAIZ . "www/minc/_funcoes.php";
$db = new cls_banco();
/* configurações */
...
$esdid = $_REQUEST['esdid'] ? $_REQUEST['esdid'] : null;
...
$destinatarios = EmailMinc::identificar_destinatarios( $orgao, $tipoEnsino, $uo, $ug, $perfis, $outros, $statusUsuario, $ideb, $arMunicipios, $cargo, array(), $esdid, $usustatus);
?>
<html>
	<head>
