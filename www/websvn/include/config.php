...
//
$config->addRepository('Simec Desenvolvimento', 'file:///var/www/simec/simec_dev/simec/');
...
//
//$config->addRepository('Simec Desenvolvimento', '//subversion.mec.gov.br/svn/simec_dev', null, 'luizmendonca', '123456');
...
//
 //$config->parentPath('/var/www/simec/simec_dev/');
