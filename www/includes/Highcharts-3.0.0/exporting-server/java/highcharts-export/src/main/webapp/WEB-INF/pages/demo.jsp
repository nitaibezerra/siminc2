...
<body>
<div id="top"><a href="http://www.highcharts.com"
	title="Highcharts Home Page" id="logo"><img
	alt="Highcharts Home Page" src="resources/Highcharts-icon-160px.png"
	border="0"></a>
...
<input id="options" title="Highcharts config object" type="radio"
	...
	class="radio">Highcharts config object (JSON)</label> <input id="svg"
	title="svg xml content" type="radio" name="content" value="svg">
<label for="svg" class="radio">SVG (XML) </label>

<div id="options"><label id="options" for="options">Options</label>
...
<textarea id="options" name="options" rows="12" cols="30"><%@include
	file="/WEB-INF/jspf/config.js"%></textarea></div>
<div id="svg"></div>
...
<label for="scales">Scale</label> <input id="scale" name="scale"
	type="text" value="" />
...
<div class="info">This will be either 'Chart' or 'StockChart'
depending on if <br />
you want a Highcharts or an HighStock chart.</div>
<select name="constr">
...
<textarea id="callback" name="callback" rows="12" cols="30" /><%@include
	file="/WEB-INF/jspf/callback.js"%>
			</textarea> <input id="submit" type="submit" value="Generate Image"></form>
</div>
<div id="toggle"><label id="svg" for="svg">Svg Content</label>
