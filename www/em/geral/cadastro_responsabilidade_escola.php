			...
			<?php
				...
				$sql = sprintf("SELECT
								...
								FROM
								 ...
								 LEFT JOIN em.emiensinomedioinovador ei ON ei.entid = e.entid
								WHERE
								 fe.funid = 3 AND
								 --tpcid IN (%d) AND
								 tpcid = $tpcid AND		 	
...
EOT;
				...
				$sql = sprintf("SELECT
								...
								FROM
								 ...
								 INNER JOIN em.emiensinomedioinovador ei ON ei.entid = ent.entid
								 LEFT JOIN em.usuarioresponsabilidade ur ON ur.entid = ent.entid AND
								 	rpustatus = 'A'	
								WHERE
								 fe.funid = 3 AND
								 --ent.tpcid IN (%s) AND
