...
if(date("H:i") > "01:30" && date("H:i") < "05:00") {
	...
	<tr>
		<td style="font-size:x-large;" align="center"><img src="../imagens/alerta_sistema.gif" border="0" align="absmiddle"> O SISPACTO 2014 em Manutenção</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td style="font-size:large;" align="center">A manutenção no SISPACTO 2014 deixará indisponível o sistema nos dias da semana : Segunda, Quarta e Sexta (01:30 às 05:00)</td>
	</tr>
	</table>
	<?
