...
$sqlResponsabilidadesPerfil = "SELECT 
									tr.*
								FROM 
									gestaodocumentos.tprperfil p
									INNER JOIN 
										gestaodocumentos.tiporesponsabilidade tr ON p.tprcod = tr.tprcod
								WHERE 
	...
	foreach ($responsabilidadesPerfil as $rp) {
		...
		switch ($rp["tprsigla"]) {	
			case "U": // unidades
				...
				$sqlRespUsuario = "
					SELECT u.unasigla as codigo, u.unadescricao as descricao FROM gestaodocumentos.usuarioresponsabilidade ur 
