	...
	if(isset($_POST['usuunidresp'])){
		foreach($_POST['usuunidresp'] as $muncod) {
		   ...
		   ";
			...
			$sqlQtd = "
				select count(*) as qtd from pdeescola.usuarioresponsabilidade 
				where
				   		usucpf  	= '$usucpf' and
				   		pflcod 	    =  $pflcod and
				   		muncod  	= '$muncod'
...
<table>
	...
	$sql = "
			...
			from 
				pdeescola.usuarioresponsabilidade ur inner join territorios.municipio m on ur.muncod = m.muncod
