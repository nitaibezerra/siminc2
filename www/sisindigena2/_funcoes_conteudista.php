...
function carregarconteudista($dados) {
	...
	$_SESSION['sisindigena2']['conteudista'] = array("descricao" => $arr['descricao']."( ".$infprof['iusnome']." )",
	...
	if($dados['direcionar']) {
		$al = array("location"=>"sisindigena2.php?modulo=principal/conteudista/conteudista&acao=A&aba=principal");
		alertlocation($al);
	}
