...
function gerenciarCoordenadorAdjunto(picid) {
	window.open('sisindigena2.php?modulo=principal/universidade/gerenciarcoordenadoradjunto&acao=A&picid='+picid,'CoordenadorAdjunto','scrollbars=no,height=600,width=800,status=no,toolbar=no,menubar=no,location=no');
}
