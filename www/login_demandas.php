...
/* Constantes especificas para este arquivo */
...
<html>
	<head>
		...
		<meta name="keywords" content="<?php echo SIGLA_SISTEMA; ?>, MEC, PDE, Ministério da Educação, Analistas: ,Cristiano Cabral, Adonias Malosso, Gilberto Xavier">
				...
				<tr>
					<td valign='top' width="60%">
						<table cellpadding='0' cellspacing='0' border='0' width='100%'>
							...
							<tr><td>&nbsp;</td></tr>
							<?php
								$sql = "select sisid, sisabrev, sisdsc, sisfinalidade, sispublico, sisrelacionado from seguranca.sistema where sisstatus='A' and sismostra=true and sisid=".SISID_DEMANDAS." order by sisid";
							?>
				            ...
				            <td nowrap bgcolor="ececec" style="padding-left:10px;padding-right:10px;" width="350">
								<table cellpadding="2" cellspacing="0" align="center" border="0">
									...
									<tr>
										<td colspan="2">
											<p style="text-align: center">
												<input type="button" value="Solicitar Cadastro" onclick="location.href='./cadastrar_usuario.php?sisid=<? echo SISID_DEMANDAS; ?>'">
											</p>
										</td>
									</tr>
