...
define('CLASSES_CONTROLE', APPRAIZ . 'scrum/classes/controllers/');
define('CLASSES_MODELO', APPRAIZ . 'scrum/classes/models/');
define('CLASSES_VISAO', APPRAIZ . 'scrum/classes/views/');
