...
style=menuStyle;
top=10;
//aI("text=teste;url=http://www.milonic.com/;");
aI("showmenu=hgjfgjhf;text=dfsgsdfgsf;");
aI("showmenu=Mifgjfflonic;text=sdfgsdfgdfc;");
aI("showmenu=Pafjhfgjhfrtners;text=Pgsersdfgsdfg;");
aI("showmenu=Lingfjhfhfhks;text=sdfgsdfgsd;");
aI("showmenu=MyMfjgjgilonic;text=My sdgsds;");
}
