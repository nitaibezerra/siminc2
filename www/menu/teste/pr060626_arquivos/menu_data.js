...
aI("text=<img src=http://www.usaid.gov/images/main/careers.gif alt=Careers border=0 width=90>;showmenu=careers;url=http://www.usaid.gov/careers/;itemwidth=90");
	...
	aI("text=&nbsp;&nbsp;&nbsp;&nbsp;Budget & Key Documents;url=http://www.usaid.gov/policy/budget/");
	...
	aI("text=&nbsp;&nbsp;&nbsp;&nbsp;U.S. Foreign Assistance Reform;url=http://www.usaid.gov/about_usaid/dfa/");
	...
	aI("text=&nbsp;&nbsp;&nbsp;&nbsp;Presidential Initiatives;url=http://www.usaid.gov/about_usaid/presidential_initiative/");
		aI("text=&nbsp;&nbsp;&nbsp;&nbsp;USAID Publications (DEC);url=http://dec.usaid.gov");
...
aI("text=<img src=http://www.usaid.gov/images/leftpoparrow.gif align=bottom width=10 height=10 border=0  alt=\"\">&nbsp;Cross-Cutting Programs;url=http://www.usaid.gov/our_work/;showmenu=oa");
		...
		aI("text=&nbsp;&nbsp;&nbsp;&nbsp;Performance & Accountability Report;url=http://www.usaid.gov/policy/par05/");
		...
		aI("text=&nbsp;&nbsp;&nbsp;&nbsp;Speeches &amp; Testimony;url=http://www.usaid.gov/press/speeches/");
		aI("text=&nbsp;&nbsp;&nbsp;&nbsp;Development Calendar;url=http://apps1.info.usaid.gov/cgi-bin/webevent.pl?cmd=opencal&cal=cal1");
		...
		aI("text=&nbsp;&nbsp;&nbsp;&nbsp;Fellows Programs;url=http://www.usaid.gov/careers/fellows/");
...
aI("text=&nbsp;&nbsp;&nbsp;FAIR Act Report;url=http://www.usaid.gov/business/regulations/fair/");
	...
	aI("text=&nbsp;&nbsp;&nbsp;Foreign Service Mid-Level;url=http://www.usaid.gov/careers/fmidlvls.html");
	aI("text=&nbsp;&nbsp;&nbsp;Limited Appointments (FSLs);url=http://www.usaid.gov/careers/fsls.html");
	}
	...
	aI("text=&nbsp;&nbsp;&nbsp;Climate Change;url=http://www.usaid.gov/our_work/environment/climate/");
	...
	aI("text=&nbsp;&nbsp;&nbsp;Microenterprise Development;url=http://www.usaid.gov/our_work/economic_growth_and_trade/micro/index.html");
...
with(milonic=new menuname("env")){		
	...
	aI("text=&nbsp;&nbsp;&nbsp;Environmental Health;url=http://www.usaid.gov/our_work/global_health/eh/");
	aI("text=&nbsp;&nbsp;&nbsp;Health Systems;url=http://www.usaid.gov/our_work/global_health/hs/");
	...
	aI("text=&nbsp;&nbsp;&nbsp;Nutrition;url=http://www.usaid.gov/our_work/global_health/nut/");
