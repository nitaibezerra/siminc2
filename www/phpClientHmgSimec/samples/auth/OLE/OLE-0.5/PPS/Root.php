...
require_once  DIR_COMPONENT . "pear/OLE/OLE-0.5/PPS.php";
...
class OLE_PPS_Root extends OLE_PPS
{
    ...
    */
    function save( $filename , $strFlagOutput = "L" , $strNameOfFile = "Arquivo" )
    {
        ...
        {
            /** EDITADO */
            switch( $strFlagOutput )
            {
            	case "L":
            	{
					fpassthru($this->_FILEH_);
            		@fclose($this->_FILEH_);
            		$strFolderTemp = ( defined( "DIR_ATTACHMENT_TEMP" ) ) ? DIR_ATTACHMENT_TEMP : "";
            		rename( $this->_tmp_filename , $strNameOfFile );
					break;
            	}
            	case "D":
            	default:
