<?php
	if (isset($_REQUEST['t'])) {
		...
		try {
			msgOutput("TESTE DE INFORMACOES DE USUARIO EXTERNO");
			...
			$resposta = $SSDWs->getExternalUserInfo($ticket);
...
?>
	<h3>TESTE DE INFORMACOES DE USUARIO EXTERNO</h3>
	<form method="POST">
		<label>UserTicketId:</label> <input type="text" name="t" />
