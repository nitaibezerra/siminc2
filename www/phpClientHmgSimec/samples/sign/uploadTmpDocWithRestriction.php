<?php
	if (isset($_POST['submit'])) {
		...
		try {
			msgOutput("TESTE DE ASSINATURA - UPLOAD DE DOCUMENTO COM RESTRICAO");
			...
			$resposta = $SSDWs->loadDocumentForUserSigning($file, $cpf, $marker);
...
?>
	<h3>TESTE DE ASSINATURA - UPLOAD DE DOCUMENTO COM RESTRICAO</h3>
