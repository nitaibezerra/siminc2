<?php
	if (isset($_POST['submit'])) {
		...
		try {
			msgOutput("TESTE DE USUARIO - ALTERACAO DE STATUS DE PERMISSAO DE USUARIO");
			...
			$resposta = $SSDWs->changeUserPermissionStatus($userId, $permissionId, $justification, $userPermissionStatusDesired);
...
?>
	<h3>TESTE DE USUARIO - ALTERACAO DE STATUS DE PERMISSAO DE USUARIO</h3>
	<form method="POST">
		...
		<label>Justificativa:</label> <input type="text" name="justification" value="justificativa" /><br />
		<label>Status de permiss&atilde;o de usu&aacute;rio desejada:</label> <input type="text" name="userPermissionStatusDesired" value="A"/><br />
