...
if($idPerfil == SECRETARIA_MUNICIPAL){
	...
	if(isset($_POST['usuunidresp'])){
		foreach($_POST['usuunidresp'] as $muncod) {
		   ...
		   ";
			...
			$sqlQtd = "
				select count(*) as qtd from pse.usuarioresponsabilidade 
				where
				   		usucpf  	= '$usucpf' and
				   		pflcod 	    =  $pflcod and
				   		muncod  	= '$muncod'
...
<table>
	<tr>
	<td width="498" height="340">
	<div style="OVERFLOW: AUTO; WIDTH: 498px; HEIGHT: 351px; top:0px; BORDER: 2px SOLID #ECECEC; background-color: White; position:absolute;">
	...
	$sql = "
			...
			from 
				pse.usuarioresponsabilidade ur inner join territorios.municipio m on ur.muncod = m.muncod
...
//			alert('Não é permitido marcar mais de um município por usuário!');
//			check.checked = false;
//			return;
//		}		
		// põe
