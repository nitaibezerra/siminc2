...
<div style="border:1px solid #000;width:500px;">
  ...
  <div id="menu_janela">
    <div><a href="estado_municipio_sase.php">Ações Detalhadas</a></div>
    <div><a style="background:#8f8f8f !important;" href="estado_municipio_prefeitos_sase.php">Síntese das Ações</a></div>
    <div style="clear:both"></div>
  </div>

  <div id="titulo_janela">
    <h2>Síntese das Ações</h2>
  </div>
  ...
  <div id="form_janela">
    ...
    <div>
      <span><label class="SubTituloDireita" width="30%">Município:</label></span><br/>
