...
<p class="P25"><span class="T7">Processo n.</span> <?= $numeroProcesso ?></span></p>
...
<?php 
echo pegarPagina(
	"http://portal.mec.gov.br/ide/2008/gerarTabela.php?municipio=$parecer_muncod&tbl=1,4,5&submit=Gerar+Dados",
	"Os indicadores demográficos e educacionais estão indisponíveis."
);
/* TODO Verificar se pode excluir código definitivamente.
?>
</div>
