...
, resolvem celebrar o presente <b>Termo de Cooperação Técnica</b>, em conformidade com as peças constantes no Processo nº <?= $numeroProcesso ?>
...
<p class="P7"> </p>
<p class="P5"><span class="_T3">CLÁUSULA OITAVA - A efetividade das ações assumidas pelo MEC/FNDE 
...
?>
<p class="P12"><span class="_T3">Brasília-DF, <?= date( "d" ) ?> de <?= $mes[date( "n" )-1] ?> de <?=date(Y); ?>.</span></p>
