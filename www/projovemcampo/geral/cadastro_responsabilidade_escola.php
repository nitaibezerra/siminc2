...
if(isset($_REQUEST['enviar'])) {
	...
	if($_POST['usuunidresp'][0]){
		foreach($_POST['usuunidresp'] as $entid){
			$sql = "INSERT INTO projovemcampo.usuarioresponsabilidade (entid, usucpf, rpustatus, rpudata_inc, pflcod) 
...
// 								INNER JOIN projovemcampo.nucleoescola nes ON nes.nucid = nuc.nucid AND nuestatus = 'A'
