...
# along with Mantis.  If not, see <http://www.gnu.org/licenses/>.
	...
	# --------------------
	# This function looks for text with simec_htmlentities
	...
	# --------------------
	# Calls simec_htmlentities on the specified string, passing along
	# the current charset.
	function string_html_entities( $p_string ) {
		return simec_htmlentities( $p_string, ENT_COMPAT, lang_get( 'charset' ) );
	}
