...
define('CLASSES_CONTROLE', APPRAIZ .  'demandasse/classes/controllers/');
define('CLASSES_MODELO', APPRAIZ . 'demandasse/classes/models/');
define('CLASSES_VISAO', APPRAIZ . 'demandasse/classes/views/');
...
//        $file = ucfirst(substr($file, 0, -1));
        ...
        $arr_file   = explode('_', $class);
        $file       = array_pop( $arr_file );
//        
