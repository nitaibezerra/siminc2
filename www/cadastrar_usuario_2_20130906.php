      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_modulos">
        ...
        <tr>
          ...
          <table class="tabela" width="100%" bgcolor="#f5f5f5">
			...
			<tr bgcolor="#C0C0C0">
				<td>&nbsp;</td>
				<td><input type="button" value="Voltar"	onclick="location.href='./cadastrar_usuario.php?sisid=<?=$sisid?>&modid=<?=$modid?>&usucpf=<?=$usucpf?>'"></td>
			</tr>
			<?php else: ?>
			<tr>
			...
			<tr>
				...
				<td><input id="ususexo" type="radio" name="ususexo" value="M" <?=($ususexo=='M'?"CHECKED":"")?> <?= $cpf_cadastrado ? 'disabled="disabled"' : '' ?> /> 
					<input id="ususexo" type="radio" name="ususexo" value="F"	<?=($ususexo=='F'?"CHECKED":"")?>	<?= $cpf_cadastrado ? 'disabled="disabled"' : '' ?> /> 
					<?= obrigatorio(); ?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><?= campo_texto('usufoneddd','S',$editavel,'',3,2,'##',''); ?> <?= campo_texto('usufonenum','S',$editavel,'',18,15,'###-####|####-####',''); ?>
				</td>
			</tr>
			<tr>
			...
			<tr bgcolor="#DCDCDC">
				...
				<td>
					...
					<?} ?>
					<a class="botao1" style="float:left" href="./cadastrar_usuario.php?sisid=<?= $sisid ?>&modid=<?= $modid ?>&usucpf=<?= $usucpf ?>" >Voltar</a>
				</td>
			</tr>
			<?php endif; ?>
