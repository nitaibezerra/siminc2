 ...
 */
require_once APPRAIZ . 'www/gerador/Zend/Zend/Validate/Abstract.php';
...
class Zend_Validate_Date extends Zend_Validate_Abstract
{
    ...
    {
        require_once APPRAIZ . 'www/gerador/Zend/Zend/Locale.php';
    ...
    public function isValid($value)
    {
        ...
        if (($this->_format !== null) || ($this->_locale !== null) || is_array($value) ||
            ...
            require_once APPRAIZ . 'www/gerador/Zend/Zend/Date.php';
            
            
//            ver($value, $this->_format, $this->_locale, Zend_Date::isDate($value, $this->_format, $this->_locale),d);
    ...
    {
        try {
            require_once APPRAIZ . 'www/gerador/Zend/Zend/Locale/Format.php';
