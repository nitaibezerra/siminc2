...
class Zend_Locale
{
    ...
    public static function getEnvironment()
    {
        ...
        require_once APPRAIZ . 'www/gerador/Zend/Zend/Locale/Data/Translation.php';
    ...
    {
        require_once APPRAIZ . 'www/gerador/Zend/Zend/Locale/Data.php';
        $locale            = self::findLocale($locale);
    ...
    public static function findLocale($locale = null)
    {
        ...
        if (!Zend_Locale::isLocale($locale, true, false)) {
            if (!Zend_Locale::isLocale($locale, false, false)) {
                ...
                if (empty($locale)) {
                    require_once APPRAIZ . 'www/gerador/Zend/Zend/Locale/Exception.php';
