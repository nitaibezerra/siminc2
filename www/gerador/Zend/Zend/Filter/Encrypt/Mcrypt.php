 ...
 */
require_once APPRAIZ . 'www/gerador/Zend/Zend/Filter/Encrypt/Interface.php';
...
class Zend_Filter_Encrypt_Mcrypt implements Zend_Filter_Encrypt_Interface
{
    ...
    public function encrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once APPRAIZ . 'www/gerador/Zend/Zend/Filter/Compress.php';
    ...
    public function decrypt($value)
    {
        ...
        if (!empty($this->_compression)) {
            require_once APPRAIZ . 'www/gerador/Zend/Zend/Filter/Decompress.php';
