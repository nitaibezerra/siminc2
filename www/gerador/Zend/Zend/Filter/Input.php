 ...
 * @see Zend_Loader
 */
require_once APPRAIZ . 'www/gerador/Zend/Zend/Loader.php';

/**
 * @see Zend_Filter
 */
require_once APPRAIZ . 'www/gerador/Zend/Zend/Filter.php';

/**
 * @see Zend_Validate
 */
require_once APPRAIZ . 'www/gerador/Zend/Zend/Validate.php';
...
class Zend_Filter_Input
{
    ...
    public function setPluginLoader(Zend_Loader_PluginLoader_Interface $loader, $type)
    {
        ...
        switch ($type) {
            ...
            case self::VALIDATE:
                ...
                return $this;
            default:
                require_once APPRAIZ . 'www/gerador/Zend/Zend/Filter/Exception.php';
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            ...
            require_once APPRAIZ . 'www/gerador/Zend/Zend/Loader/PluginLoader.php';
