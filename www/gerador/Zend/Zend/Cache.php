...
//            ver(APPRAIZ . 'www/gerador/Zend/' . str_replace('_', DIRECTORY_SEPARATOR, $backendClass) . '.php', file_exists(APPRAIZ . 'www/gerador/Zend/' . str_replace('_', DIRECTORY_SEPARATOR, $backendClass) . '.php'),d);
            require_once APPRAIZ . 'www/gerador/Zend/' . str_replace('_', DIRECTORY_SEPARATOR, $backendClass) . '.php';
        } else {
    ...
    public static function _makeFrontend($frontend, $frontendOptions = array(), $customFrontendNaming = false, $autoload = false)
    {
        ...
        if (in_array($frontend, self::$standardFrontends)) {
            ...
            // security controls are explicit
            require_once APPRAIZ . 'www/gerador/Zend/' . str_replace('_', DIRECTORY_SEPARATOR, $frontendClass) . '.php';
        } else {
    ...
    public static function throwException($msg, Exception $e = null)
    {
        ...
        require_once APPRAIZ . 'www/gerador/Zend/Zend/Cache/Exception.php';
