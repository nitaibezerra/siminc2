...
function carregarFormadorIES($dados) {
	...
	$_SESSION['sisindigena']['formadories'] = array("descricao" => $arr['descricao']."( ".$infprof['iusnome']." )",
	...
	if($dados['direcionar']) {
		$al = array("location"=>"sisindigena.php?modulo=principal/formadories/formadories&acao=A&aba=principal");
		alertlocation($al);
	}
