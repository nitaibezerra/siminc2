...
function carregarPesquisador($dados) {
	...
	$_SESSION['sisindigena']['pesquisador'] = array("descricao" => $arr['descricao']."( ".$infprof['iusnome']." )",
	...
	if($dados['direcionar']) {
		$al = array("location"=>"sisindigena.php?modulo=principal/pesquisador/pesquisador&acao=A&aba=principal");
		alertlocation($al);
	}
