...
if(isset($_REQUEST['enviar'])) {
	...
	if($_POST['usuunidresp'][0]){
		foreach($_POST['usuunidresp'] as $muncod){
			$sql = "INSERT INTO sispacto.usuarioresponsabilidade (muncod, usucpf, rpustatus, rpudata_inc, pflcod) 
...
<form name="formassocia" style="margin: 0px;" method="POST"><input
	...
	$sql = "
			...
			from 
				sispacto.usuarioresponsabilidade ur inner join territorios.municipio m on ur.muncod = m.muncod
