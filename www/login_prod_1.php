...
?>
    ...
    <table border=0 cellspacing=0 cellpadding=0 width='100%' >
        <tr >
            <td width=480 style='width:360.0pt;border:solid windowtext 1.0pt; padding:0cm 5.4pt 0cm 5.4pt;height:71.85pt;border-color:-moz-use-text-color'>
                <br>
                <p align="left"><div style="float:left"><img src="/imagens/seta_galeria1.gif" align="bottom">&nbsp;</div> <div style="float:left"><b>SISMédio</b></div></p>
    <p align="center"><font color=red size=3><strong><br><br><b>PACTO NACIONAL PELO FORTALECIMENTO DO ENSINO MÉDIO<br><br>ATENÇÃO</b><br><br></strong></font></p>
    <b>
    Para saber mais sobre o Pacto Nacional pelo Fortalecimento do Ensino Médio, leia a Resolução nº 51, de 11/12/13, disponível no site do FNDE (www.fnde.gov.br>> FNDE >> Legislação). Para acessar o Manual do SisMédio – Módulo Diretor, <a href="http://portal.mec.gov.br/index.php?option=com_content&view=article&id=20189&Itemid=811" target="_blank">clique aqui</a>.
    <br><br>
