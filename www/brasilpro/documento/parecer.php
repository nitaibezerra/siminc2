...
$sql = sprintf("SELECT 
					estdescricao 
				FROM
					cte.instrumentounidade ins join territorios.estado est on ins.estuf = est.estuf 
				WHERE
				 	inuid = %d",$inuid);
...
if($estDsc == "Mato Grosso"){
	$interessadoAtual = "Secretária de Ciência e tecnologia do estado do ";
}else{
	$interessadoAtual = "Secretária de educação do estado do ";
}
...
<h1 class="P59"><a name="Parecer_n_C2_BA" />Parecer n. <span style="font-size: 18px; font-weight: bold;"><?=$numeroParecer; ?></span></h1>
<p class="P25"><span class="T7">Processo n.</span> </p>
<p class="P25"><span class="T7">Interessado:</span><span class="T4">
<?php echo $interessadoAtual; ?> </span><span class="T14"><?= $estDsc; ?></span></p>
<p class="P25"><span class="T7">Assunto:</span><span class="T4"> Plano de Ações Articuladas/Brasil Profissionalizado</span></p>
<p class="P7"> </p>
<p class="P32"><span class="T4">O Governo Federal, por intermédio do Decreto 6.302, de dezembro de 2007, publicado no D.O.U no dia 12 de dezembro de 2007, dispõe sobre a implementação do "PAR/Brasil profissionalizado", assim definido em seu Art. 1. "Fica instituído, no âmbito do Ministério da Educação, o Programa Brasil Profissionalizado, com vistas a estimular o ensino médio integrado à educação profissional, enfatizando a educação científica e humanística, por meio da articulação entre formação geral e educação profissional no contexto dos arranjos produtivos e das vocações locais e regionais" <span
	class="T4"> </span></p>
<p class="P50">Considerando os princípios básicos do Plano de Desenvolvimento da Educação - PDE - educação sistêmica, ordenação territorial e desenvolvimento, com foco nos propósitos de melhoria da qualidade da educação no ensino médio e na redução de desigualdades relativas às oportunidades educacionais, o Ministério da Educação construiu 64 indicadores, distribuídos em 04 (quatro) Dimensões (Gestão Educacional; Formação de Professores e Profissionais de Serviço e Apoio Escolar; Práticas Pedagógicas e Avaliação; e Infra- estrutura física e Recursos Pedagógicos) que nortearam o Estado do <?= $estDsc; ?> na realização do diagnóstico da educação básica no ensino médio e na educação profissional e tecnológica do sistema local. </p>
<p class="P31"><span class="T4">A partir desse diagnóstico, o Estado do <?=$estDsc;?> elaborou o PAR/Brasil profissionalizado que visa a expansão do ensino médio integrado a educação profissional e tecnológica no âmbito estadual.”</span><span class="T4"> </span></p>
<p class="P31"><span class="T4">O Fundo Nacional de Desenvolvimento da Educação - FNDE recebeu do (a) Estado do <?= $estDsc; ?>, o PAR/Brasil profissionalizado contendo as ações que podem contribuir para a melhoria das condições de acesso e permanência dos alunos, e para o desenvolvimento do ensino médio integrado na rede pública da educação básica, na forma do disposto no Decreto 5154/2004  e da RESOLUÇÃO/FNDE/CD/ No 062, DE 12 DE DEZEMBRO DE 2007 Ainda de acordo com a mesma resolução, o FNDE, após análise preliminar, encaminhou o PAR do estado do <?=$estDsc; ?>  à Comissão Técnica Permanente, instituída pela Portaria Ministerial n° 698, de 27/06/2008, publicada no Diário Oficial da União em 02/07/2008 em conformidade com as diretrizes estabelecidas no PAR/Brasil profissionalizado.</span></p>
<p class="P51">1 - Da Análise </p>
<p class="P46"><span class="T4">A Secretaria de estado de educação do <?=$estDsc;?> aderiu ao PAR/Brasil profissionalizado, sendo beneficiado com as ações suplementares de assistência técnica e financeira de que trata a RESOLUÇÃO/FNDE/CD/ No 062, DE 12 DE DEZEMBRO DE 2007 alterada pela RESOLUÇÃO/CD/FNDE Nº 09 DE 29 DE FEVEREIRO de 2008</span></p>
<!--
<p class="P46"><span class="T4">A tabela a seguir apresenta o IDEB do estado do <?=$estDsc; ?> relativas ao ensino médio no ano de 2005, juntamente com a projeção até 2021, decorrentes do desenvolvimento de ações contempladas no Plano de Ações Articuladas/PAR, que possibilitarão o cumprimento das diretrizes estabelecidas no Termo de Adesão e o alcance das metas previstas.</span></p>
...
*/
		echo "<strong>Inserir aqui tabela com dados do IDEB</strong>";
		?>
	</div>
<?php // endif; ?>

 
<p class="P64"><span class="T10">De acordo com os dados fornecidos pelo INEP, o Estado do <?=$estDsc; ?> apresenta os seguintes indicadores demográficos e educacionais: </span></p>
...
*/
echo "<strong>Inserir aqui tabela com dados do INEP</strong>";
?>
</div>
...
--!>
<p class="P49">O instrumento para coleta de informações qualitativas, componente do Diagnóstico do Contexto Educacional, propõe a ponderação de indicadores educacionais, estruturados em 4 (quatro) grandes dimensões, contemplando aspectos da realidade do sistema estadual. De forma geral, o diagnóstico realizado pelo estado apresentou a seguinte pontuação:  </p>
...
<p class="P47"><span class="T4">A partir da pontuação gerada para cada indicador presente nas 04 (quatro) Dimensões, o estado do <?=$estDsc; ?> elaborou o PAR detalhando suas ações. </span></p>
<!--
...
-->
<p class="P50">
O resultado do detalhamento das ações, contempladas no PAR do estado, está organizado de acordo com a forma de execução, estratégia de implementação e cronograma, com metas quantitativas e qualitativas para execução de 2008 a 2011 e apresenta as seguintes ações: 
</p>
...
<p class="P47"><span class="T4">Dessa forma, o PAR/Brasil profissionalizado do estado do <?= $estDsc; ?>  composto de diagnóstico do contexto educacional e das metas a atingir para o desenvolvimento do IDEB, apresenta coerência com as diretrizes do Plano de Metas Compromisso Todos pela Educação, Decreto n. 6.094, de 24 de abril de 2007 e do Programa Brasil profissionalizado, decreto 6.302 de 12 de dezembro de 2007.</span></p>
<p class="P47"><span class="T4"> </span><span class="T6" style="font-weight: bold;">2 - Da
conclusão</span></p>
<p class="P33">Tendo procedido à análise do PAR, esta Comissão Técnica Permanente recomenda a implementação para o exercício de 2008 das ações nele constantes e encaminha o presente parecer e o respectivo Plano ao FNDE para execução, a partir da análise dos custos estimados para realização das ações contempladas no PAR, consoante a confirmação da disponibilidade orçamentária.</span></p>
<p class="P49">Cabe destacar que a elaboração do Plano de Trabalho, na forma do anexo III, RESOLUÇÃO/FNDE/CD/ No 062, DE 12 DE DEZEMBRO DE 2007 alterada pela RESOLUÇÃO/CD/FNDE Nº 09 DE 29 DE FEVEREIRO de 2008, deverá indicar o conjunto de ações que o estado pretende propor como meta para o alcance dos objetivos operacionais necessários à melhoria dos índices previstos para o primeiro ano, garantindo-se a sustentabilidade para a execução das ações subseqüentes, que compõem o PAR/Brasil profissionalizado. </p>
<p class="P46"><span class="T4">Assim, a Comissão Técnica Permanente aprova o PAR/Brasil profissionalizado e recomenda a formalização de convênio e termo de cooperação técnica, com a apresentação de plano de trabalho, na forma do disposto na Resolução RESOLUÇÃO/FNDE/CD/ No 062, DE 12 DE DEZEMBRO DE 2007 alterada pela RESOLUÇÃO/CD/FNDE Nº 09 DE 29 DE FEVEREIRO de 2008</span></p>
...
<table border="0" cellspacing="0" cellpadding="0" class="Table6">
	...
	<tr class="Table61">
		...
		<p class="P44"> </p>
		<p class="P38">Representante da SETEC/MEC </p>
		</td>
		<td style="text-align:left;width:1.27cm; " class="Table6A1">
		<p class="P40"> </p>
		</td>
