...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			* .Textodebalão { font-family: Tahoma; font-size: 11pt; }
			* .Textodecomentário { font-family: Arial; font-size: 11pt; }
...
<body dir="ltr">
	...
	<p class="P11">
		<span class="_T3"><b>TERMO DE COOPERAÇÃO TÉCNICA</b> Nº </span>#TERMO#
		<span class="_T3">QUE ENTRE SI CELEBRAM O MINISTÉRIO DA EDUCAÇÃO - MEC E O MUNICÍPIO DE </span><span style="text-transform:uppercase;"><?= $prefeitura["mundescricao"]."/".$prefeitura["estuf"] ?></span>
		<span class="_T3"> REPRESENTADO PELA </span><?= $prefeitura["entnome"] ?>.
	</p>
	<p>&nbsp;</p>
<p class="P25">
A União, por meio do Ministério da Educação - MEC, inscrito no CNPJ sob o nº 00.394.445/0124-52, com sede na Esplanada dos Ministérios, Bloco L, Brasília/DF, neste ato representado pelo ministro de Estado Fernando Haddad</span>
, e o MUNICÍPIO DE <span style="text-transform:uppercase;"> <?= $prefeitura["mundescricao"]."/".$prefeitura["estuf"] ?></span>
, representado pela  <?= $prefeitura["entnome"] ?>
, inscrita no CNPJ/MF sob o nº <?= $prefeitura["entnumcpfcnpj"] ?>
...
<?// , Carteira de Identidade nº <?= $prefeito["entnumrg"] ?>
<? //, expedida pelo(a) <?= $prefeito["entorgaoexpedidor"]// ?>
, CPF nº <?= $prefeito["entnumcpfcnpj"] ?>
, resolvem celebrar o presente <b>Termo de Cooperação Técnica</b>, em conformidade com as peças constantes no Processo nº <?= $prefeitura["munprocesso"] ?>
, nos termos do Decreto nº 6094 de 24 de abril de 2007, mediante as cláusulas e condições a seguir estabelecidas:
...
<b>Termo de Cooperação Técnica</b>
tem por objeto a conjugação de esforços entre as partes para a promoção de ações e atividades que contribuam para o processo de desenvolvimento educacional do município, visando a melhoria do Índice de Desenvolvimento da Educação Básica - IDEB.

</p>
<p class="P7"> </p>
<p class="P5"><span class="_T3">Parágrafo único -  O MEC designa
como unidades executoras do presente </span><span class="_T5"><b>Termo
de Cooperação Técnica</b></span><span class="_T3"> o Fundo Nacional
...
<div class="Sect1">
<p class="P14"> </p>
<p class="P10">DAS AÇÕES </p>
<p class="P10"> </p>
<p class="P5"><span class="_T3">CLÁUSULA SEGUNDA - A implementação do</span><span
	class="_T5"> <b>Termo de Cooperação Técnica</b> </span><span class="_T3">se
...
<p class="P7"> </p>
<p class="P10">DAS ATRIBUIÇÕES DOS PARTÍCIPES</p>
<p class="P7"> </p>
<p class="P6"><span class="_T3">CLÁUSULA TERCEIRA - Compete
conjuntamente aos partícipes:</span></p>
<p class="P16"> </p>
<ol style="margin-left: 0.5cm; list-style-type: lower-alpha;">
	...
	elaborar e prover apoio técnico aos programas e projetos a serem
	definidos para a implementação do presente Termo;</span></p>
	</li>

	<li class="P17" style="margin-left: 2.5cm;">
	<p class="P17" style="margin-left: 0.25cm;"><span class="T6">d</span><span
		class="_T3">isponibilizar materiais e informações técnicas necessárias
	à implementação dos programas e projetos;</span></p>
	</li>

	<li class="P17" style="margin-left: 2.5cm;">
	<p class="P17" style="margin-left: 0.25cm;"><span class="_T3">acompanhar,
	monitorar e avaliar os resultados alcançados nas ações e atividades
	programadas, visando a otimização e/ou adequação quando necessários;</span></p>
	</li>

	<li class="P20" style="margin-left: 2.5cm;">
	<p class="P20" style="margin-left: 0.25cm;">conduzir todas as
	atividades com eficiência e dentro de práticas administrativas e
	técnicas adequadas. </p>
	</li>
</ol>
<p class="P8"> </p>
<p class="P29">DA VIGÊNCIA </p>
<p class="P29"> </p>
<p class="P34"><span class="T12">CLÁUSULA QUARTA - O presente </span><span
	class="T13"><b>Termo de Cooperação Técnica</b> </span><span class="T12">vigorará pelo
...
de no mínimo 30 (trinta) dias.</span></p>
<p class="P35"> </p>


<p class="P29">DAS ALTERAÇÕES (AJUSTES)</p>
<p class="P29"> </p>
<p class="P34"><span class="T12">
CLÁUSULA QUINTA - O presente <b>Termo de Cooperação Técnica</b> poderá ser ajustado (aditivado), sempre que houver acordo para alteração das ações previstas no Plano de Ações Articuladas.
</span></p>
<p class="P35"> </p>
...
<p class="P40"> </p>
<p class="P5"><span class="_T3">CLÁUSULA SEXTA - Não haverá transferência
voluntária de recursos financeiros entre os partícipes para a execução
deste </span><span class="_T5"><b>Termo de Cooperação Técnica</b>.</span><span
	class="_T3"> As despesas necessárias à plena consecução do objeto
...
partícipes e/ou outros parceiros</span><span class="_T4">.</span></p>
<p class="P7"> </p>
<p class="P10">DA RESCISÃO </p>
<p class="P10"> </p>
<p class="P21"><span class="_T3">CLÁUSULA SÉTIMA - A rescisão deste
...
com o objeto, e ainda por razões de interesse público.</span></p>
<p class="P7"> </p>
<h1 class="P37"><a name="DA_PUBLICA_C3_87_C3_83O" />DA PUBLICAÇÃO</h1>
<p class="P10"> </p>
<p class="P21"><span class="_T3">CLÁUSULA OITAVA - A publicação deste <b>Termo de Cooperação 
Técnica</b> será efetivada, por extrato, no Diário Oficial da União, que correrá à conta do 
MEC as despesas correspondentes.</span></p>
<p class="P7"> </p>
<p class="P7"> </p>
<p class="P10">DAS DISPOSIÇÕES GERAIS </p>
<p class="P7"> </p>
<p class="P5"><span class="_T3">CLÁUSULA NONA - A efetividade das ações assumidas pelo MEC/FNDE 
...
?>
<p class="P12"><span class="_T3">Brasília-DF, <?= date( "d" ) ?> de <?= $mes[date( "n" )-1] ?> de 2008.</span></p>
...
<div style="page-break-before: always;">
	<h1>Anexo 1</h1>
	<p>
		Assistência Técnica do MEC ao Município <?= $prefeitura["mundescricao"] ?>.
	</p>
	<p>&nbsp;</p>
	<?php
	$dimdsc = "";
