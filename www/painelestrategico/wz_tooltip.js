...
config. BgColor			= '#45545D'	// Background colour (HTML colour value, in quotes)
...
config. CloseBtnText	= '<img src="img/tip-close.gif" alt="fechar" width="18" height="18" />'	// Close button text (may also be an image tag)
...
config. FontFace		= '"Trebuchet MS", Tahoma, Arial, Helvetica, sans-serif'
...
config. ShadowColor		= '#B1C8B3'
config. ShadowWidth		= 5
config. Sticky			= true		// false or true - fixate tip, ie. don't follow the mouse and don't hide on mouseout
config. TextAlign		= 'left'	// 'left', 'right' or 'justify'
config. Title			= '<img src="img/tip-top.gif" width="178" height="18" />'		// Default title text applied to all tips (no default title: empty string '')
config. TitleAlign		= 'left'	// 'left' or 'right' - text alignment inside the title bar
config. TitleBgColor	= '#45545D'		// If empty string '', BorderColor will be used
config. TitleFontColor	= '#45545D'	// Color of title text - if '', BgColor (of tooltip body) will be used
