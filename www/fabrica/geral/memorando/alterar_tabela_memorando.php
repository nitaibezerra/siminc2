...
if ( $idPrestadoraServico == PrestadorServico::PRESTADORA_SERVICO_FABRICA ||
     ...
     $idPrestadoraServico == PrestadorServico::PRESTADORA_SERVICO_MBA )
{
    ...
    if ( $listaDeOrdensDeServico == null )
    {
        $tabela .= "
			<tbody>
				<tr>
					<td colspan=\"11\" class=\"alignCenter\">Não foram encontrados registros</td>
				</tr>
			</tbody>
		";
    } else
    ...
    if ( $idPrestadoraServico == PrestadorServico::PRESTADORA_SERVICO_MBA ){
        $textoMemorando = Memorando::TEXTO_PADRAO_MEMORANDO_MBA;
    }
...
} else
{
    ...
    if ( empty($listaDeOrdensDeServico)  )
    {
        $tabela .= "
			<tbody>
				<tr>
					<td colspan=\"10\" class=\"alignCenter\">Não foram encontrados registros</td>
				</tr>
			</tbody>
		";
    } else
