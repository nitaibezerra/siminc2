...
<?PHP
    ...
    $sqlResponsabilidadesPerfil = "
        SELECT tr.*
        FROM contratogestao.tprperfil p
        INNER JOIN contratogestao.tiporesponsabilidade tr ON p.tprcod = tr.tprcod
...
?>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="width:100%; border: 0px; color:#006600;">
                    <tr>
                        <td style="text-align: center;"><font color='red'>Não existem atribuções a este Perfil.</font></td>
                    </tr>
                </table>
<?PHP
            } else {
