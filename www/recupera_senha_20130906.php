...
<body>
	<div id="barra_governo">
		<div id="mec">
		<h1><a href="http://portal.mec.gov.br/" target="_self" name="topo"><img src="../imagens/h1pq.gif" width="167" height="21" alt="Minist&eacute;rio da Educa&ccedil;&atilde;o" /></a></h1></div>
		<div id="menu_brasil">		
		<label for="Governo">
		        <select onchange="janela(this.value)" class="select_gov" id="Governo" title="Destaques do Governo Federal">			
		...
		<div id="selo_brasil">
		<a href="http://www.brasil.gov.br/" target="_blank"><img src="../imagens/selo_brasil_pq.gif" width="74" height="21" alt="Brasil: um pa&iacute;s de todos" /></a></div>
	</div>
