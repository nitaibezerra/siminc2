<?php
	...
	<div style="font-size:12px; margin:3px; text-align:center;width:230px;">
	...
	<div style="font-size:12px;cursor:pointer;width:230px;" onclick="exibeListaMunicipio('<?php echo $_POST['muncod'] ?>');" style="cursor:pointer;width:100%;text-align:right">Mais detalhes...</div>
