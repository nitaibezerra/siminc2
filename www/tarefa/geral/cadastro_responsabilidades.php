...
$sqlResponsabilidadesPerfil = "SELECT 
								...
								FROM 
									tarefa.tprperfil p
									INNER JOIN 
										tarefa.tiporesponsabilidade tr ON p.tprcod = tr.tprcod
								WHERE 
	...
	foreach ($responsabilidadesPerfil as $rp) {
		...
		switch ($rp["tprsigla"]) {	
			case "U": // unidades
				...
				$sqlRespUsuario = "
					SELECT u.unasigla as codigo, u.unadescricao as descricao FROM tarefa.usuarioresponsabilidade ur 
						INNER JOIN tarefa.unidade u on ur.unaid = u.unaid
