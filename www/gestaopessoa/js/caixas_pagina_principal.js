...
function definrCoresCaixas(){
    ...
    //#CAIXA 1_1
    var indice_a = aleatorio();
    $('#divCaixa_1_1').css("background-color", corPri[indice_a]);
    $('#btnCaixa_1_1').mouseover(function(){
        $('#btnCaixa_1_1').css("background-color", corSec[indice_a]);
    });
    $('#btnCaixa_1_1').mouseout(function(){
        $('#btnCaixa_1_1').css("background-color", "#FFF");
    });
    
    //#CAIXA 1_2
    var indice_a = aleatorio();
    $('#divCaixa_1_2').css("background-color", corPri[indice_a]);
    $('#btnCaixa_1_2').mouseover(function(){
        $('#btnCaixa_1_2').css("background-color", corSec[indice_a]);
    });
    $('#btnCaixa_1_2').mouseout(function(){
        $('#btnCaixa_1_2').css("background-color", "#FFF");
    });
