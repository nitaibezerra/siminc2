...
if($_REQUEST['ideb']){  
		if($_REQUEST['muncodcompleto'] && $_REQUEST['mundescricao'] && $_REQUEST['muncod']) {
			$daurl = "http://sistemasideb.inep.gov.br:7000/ContentManager2009.php?tipo=municipio&cod=".$_REQUEST['muncod'];
...
//			echo $snoopy->results;
		...
		if($_REQUEST['estcod']) {
			$daurl = "http://sistemasideb.inep.gov.br:7000/ContentManager2009.php?tipo=estado&cod=".$_REQUEST['estcod'];
...
//			echo str_replace(array("($('estado')[$('estado').selectedIndex].innerHTML)","$('nomeEstadoHolder')"),array("'".$_REQUEST['estdescricao']."'","document.getElementById('nomeEstadoHolder')"),$snoopy->results);
		...
		if($_REQUEST['esccodinep']) {
			$daurl = "http://sistemasideb.inep.gov.br:7000/ContentManager2009.php?tipo=escola&cod=".$_REQUEST['esccodinep'];
...
//			echo str_replace(array("($('estado')[$('estado').selectedIndex].innerHTML)","$('nomeEstadoHolder')"),array("'".$_REQUEST['estdescricao']."'","document.getElementById('nomeEstadoHolder')"),$snoopy->results);
		...
		if($_REQUEST['brasil']) {
			$daurl = "http://sistemasideb.inep.gov.br:7000/ContentManager2009.php";
		}
