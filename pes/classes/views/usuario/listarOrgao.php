...
<table cellpadding="3" style="width:100%;" bgcolor="#e7e7e7">
...
<script lang="javascript" contentType="text/html; charset=UTF-8">
    ...
    function carregarUnidadeOrcamentaria( orgcodigo )
    {
        ...
        $.ajax( {
            type: "POST",
            url: url,
            data: { controller : 'Usuario' , action: 'listarUO', orgcodigo: orgcodigo },
    ...
    /**
     * Esconde as unidades orcamentarias do orgao selenecionado.
     * 
     * @name esconderUnidadeOrcamentaria
     * @param {integer} orgcodigo - Codigo do orgao.
     * 
     * @since 07/06/2013
     * @author Ruy Junior Ferreira Silva <ruy.silva@mec.gov.br>
